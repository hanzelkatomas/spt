...
\vspace*{7cm}
\begin{center}%
{\Large Projekt S\+PT -\/ převodník čísel }\\
\vspace*{1cm}
{\large Generováno programem Doxygen 1.8.15}\\
\end{center}
\end{titlepage}
...
\chapter{Dokumentace projektu -\/ převodník čísel}
...
\input{namespace_projekt___s_p_t}
\chapter{Dokumentace tříd}
\input{class_projekt___s_p_t_1_1_program}
